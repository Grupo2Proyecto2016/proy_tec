...
<html ng-app="goOnApp">
        ...
        <header>
            ...
            <div class="container">
                <div class="navbar-header">
                    <a class="navbar-brand" href="/">GoOn Administrador de empresas</a>
                </div>

                <ul class="nav navbar-nav navbar-right">
                    <li><a href="#"><i class="fa fa-home"></i> Inicio</a></li>
                    <li><a href="#companies"><i class="fa fa-list"></i> Empresas</a></li>
                    <li><a href="#newCompany"><i class="fa fa-plus-circle"></i> Crear Empresa</a></li>
    ...
    <footer>
    	<p style="text-align: center;">© 2016 GoOn tecnologies S.A</p>
    </footer>
 </html>
