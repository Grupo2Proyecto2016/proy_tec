goOnApp.controller('packageController', function($scope, $http, uiGridConstants, i18nService, $timeout) 
{
    ...
    $scope.travelsGrid = 
    {
    	...
    	[
          ...
          { name:'Origen', field: 'linea.origen.descripcion', enableFiltering: false, cellTooltip: true },
          { name:'Destino', field: 'linea.destino.descripcion', cellTooltip: true },
          { name:'Salida', cellTemplate: '<div class="text-center ngCellText">{{ row.entity.inicio | date:"dd/MM/yyyy @ h:mma"}}</div>', enableFiltering: false, enableSorting: false },
    ...
    $scope.packagesGrid = 
    {
        ...
        columnDefs:
    	[
          { name:'CI emisor', field: 'ci_emisor', width: '80', enableSorting: false, cellTooltip: true },
          { name:'CI receptor', field: 'ci_receptor', width: '90', enableSorting: false, cellTooltip: true },
          { name:'Origen', field: 'viaje.linea.origen.descripcion', width: '*', enableFiltering: false, cellTooltip: true },
          ...
          { name:'Estado', field: 'statusDes', width: '100', cellTooltip: true },
          { name: ' ',
          	enableFiltering: false,
          	enableSorting: false,
          	width: '60',
