...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
	    ...
	    protected void configure(HttpSecurity httpSecurity) throws Exception {
	        httpSecurity
	                ...
	                .antMatchers("/*/emailExists").permitAll()
	                .antMatchers("/*/registerUser").permitAll()
	                .antMatchers("/*/getCompany").permitAll()
	                .antMatchers("/*/getUserInfo").permitAll()
	                .antMatchers("/*/getBranches").permitAll()
	                .antMatchers("/*/getTerminals").permitAll()
	                .antMatchers("/*/getBranchesTerminals").permitAll()
	                .antMatchers("/*/calcPackage").permitAll()
	                .antMatchers("/*/tenantExist/**").permitAll()
	                ...
	                .antMatchers("/*/getSeats").permitAll()
	                .antMatchers("/*/getTicketValue").permitAll()
	                .antMatchers("/*/getPaypal").permitAll()
	                .antMatchers("/*/getLine").permitAll()
	                .antMatchers("/*/FindNextStationsByOrigin").permitAll()
